...
//     namespace nsp {
//         template< class T >
//         inline T increment( volatile T* var );
//         {
// //        char this_is_not_acceptable_you_must_provide_implementation[-1];
//             throw std::runtime_error("what??");
//         }
//         template< class T >
//         inline T decrement( volatile T* var );
//         {
// //        char this_is_not_acceptable_you_must_provide_implementation[-1];
//             throw std::runtime_error("what??");
//         }
...
//         template<>
//         inline long increment<long>( volatile long* var )
//         {
//         }
//         template<>
//         inline long decrement<long>( volatile long* var )
//         {
//         }
//     }
